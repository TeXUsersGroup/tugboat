...
Sundqvist using MetaPost, Lua, and \ConTeXt. The three trees
were created using recursive systems. Their article on pages
\thisissuepageref{hagen-lsystems} has the details.
...
\smallskip
\noindent Printed in \USA{} [printing date:\ April \the\year]
\newcol
