...
\def\rateyear{%
  \count255=\year
  \ifnum\issnumber=3 \advance\count255 by 1 \fi
  \the\count255
}
\def\tug{\acro{TUG}}
\def\rtitle{}
...
\TUG{}. Web: \tbsurl{tug.org/TUGboat}.

\bigskip \noindent {\bf Individual \tug\ memberships}
...
of \TUB\/ for the year in which membership begins or is renewed,
as well as discounts and other benefits.
...
continuing interest in and support for \TeX\ and \tug. Patron
memberships to provide extraordinary support are also available. These
also provide a discounted rate for individual members,
site-wide electronic access, and other benefits. For details,
see \tbsurl{tug.org/instmem} or contact the \tug\ office.

\bigskip \noindent {\bf About the cover}

\noindent The cover drawing was created by E.P. Unny for the \tug'25
conference. Mr.~Unny executed many other sketches, available at
\tbsurl{tug.org.in/sketches.html}.
...
\vskip 0pt plus1filll \smallskip\bigskip\noindent
\TUB\ vol.\,\volnumber, no.\,\issnumber

\smallskip
\noindent Printed in \USA{} [printing date:\ August \the\year]
\newcol
...
\person{Erik Nijenhuis\1\\Vice President}
\person{Karl Berry\1\\Treasurer}
\person{Jim Hef{}feron\1\\Secretary}
\person{Barbara Beeton\1}% \\\TUB~Editor}
\person{Doris Behrendt}
\person{Johannes Braams}
\person{Max Chernoff}
\person{Kaja Christiansen}
\person{Ulrike Fischer}
\person{Klaus H\"oppner}
\person{Tom Hejda}
\person{J\'er\'emy Just}
\person{Frank Mittelbach}
\person{Norbert Preining}
\person{Boris Veytsman\1}
\person{Raymond Goucher (1937--2019)\\\rlap{Founding Executive Dir.\2}}
%\person{Raymond Goucher (1937--2019)\\ 
%  \null\kern5.15em Founding Executive Director\2}
\person{Hermann Zapf (1918--2015)\\Wizard of Fonts\2}
...
\smallskip
{\ninepoint
See \tbsurl{tug.org/board} for a roster of all past and present
...
{\eightpoint %\parindent=\normalparindent  
\parskip=4pt \raggedright
