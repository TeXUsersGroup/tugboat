...
[printing date: qqqmonthname \the\year]
...
\def\3{\relax}%{\ifhmode\/\fi$^{+}$} % no business committee for ages
...
% \1\3 on title of president, not name, since ex officio.
\person{Boris Veytsman\\President\1\3}% 
\person{Arthur Rosendahl\1\3\\Vice President}%
\person{Karl Berry\1\3\\Treasurer}%
\person{Klaus H\"oppner\1\3\\Secretary}%
\person{Barbara Beeton}% \\\TUB~Editor}%
