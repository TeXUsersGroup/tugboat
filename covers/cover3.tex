...
\abovecapsuleskip    = 1.5pt plus1pt
...
% #2 is TB category -- can have replace| or add| directive
% #3 is author -- can have person| directive
% #4 is title
% #5 is for statement
% #6 is page number
% #7 is url of article, usually (nowadays) using !TBIDENT!
% #8 is subtitles in TeX, but not printed on c3
% #9 is for text added to html only
