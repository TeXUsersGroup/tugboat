...
%D modify. Since \TUGBOAT\ usually does not typeset on grid, I redid the
...
% Break after / and . in urls, not before.
...
\defineblank[tugblank][3pt plus 1pt minus 1pt]
\setupblank[3pt plus 1pt minus 1pt]
